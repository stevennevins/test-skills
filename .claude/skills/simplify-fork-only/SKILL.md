---
name: simplify-fork-only
description: Review changed code for reuse, quality, and efficiency, then fix any issues found. Test variant with context fork only (no agent).
context: fork
---
